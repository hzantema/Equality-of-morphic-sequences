...
As FreePascal is open source, the source code may be compiled for other platforms for free.

Apart from the programs several example files are included. 
They may serve as input for the programs, but also contain the output of the programs: proofs that the encoded morphic sequeunces are equal. 
